...
object Concrete extends App {
  ...
  val x = Relation("Concrete.csv", "concrete_x", null, -1).toMatriD(x_cols)
  val y = Relation("Concrete.csv", "concrete_Y", null, -1).toVectorD(7)
  val y_mat = Relation("Concrete.csv", "concrete_Y_Mat", null, -1).toMatriD(y_cols)
  val xy = Relation("Concrete.csv", "concrete_x_Y", null, -1).toMatriD(all_cols)
